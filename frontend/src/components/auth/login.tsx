			...
			<div className="flex min-h-screen items-center justify-center px-4">
				<div className="w-full max-w-[380px]">
					<div className="mb-6 text-center">
						...
						<h1 className="text-lg font-semibold tracking-tight text-white">Log in to Runmesh</h1>
						<p className="mt-1.5 text-sm text-muted-foreground">Use your GitHub account to continue</p>
					</div>
					...
					<div className="mt-6 text-center text-sm text-muted-foreground">
						...
						<Link to="/signup" className="text-link-primary no-underline transition-colors hover:text-white">
							Sign up
						</Link>
					</div>
